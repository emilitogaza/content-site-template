...
const SITE_NAME = "Docs Starter";
const SITE_TITLE = "Docs Starter — a content-driven site template";
const SITE_DESCRIPTION =
  "A minimal, content-driven docs and course starter built with Next.js and Tailwind. Drop Markdown files into content/, pick a theme colour and a Lucide icon, and ship.";

// Browser UI colour (address bar). Keep in sync with the `--color-accent-*`
// ramp in globals.css: light = accent-50, dark = accent-950.
